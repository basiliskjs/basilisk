  ...
  var Vector = (function () {
      ...
      */
      Vector.prototype.find = function (fn, context) {
          var _this = this;
          if (typeof context === "undefined") { context = undefined; }
          var value = undefined, found = false;
          this.forEach(function (item, index) {
              if (found) {
                  return;
              }
      ...
      Vector.prototype.map = function (mapper, context) {
          if (typeof context === "undefined") { context = undefined; }
          var changed = [];

          this.forEach(function (current, index, vect) {
              changed.push(mapper.call(context, current, index, vect));
          });

          return Vector.from(changed);
      };
